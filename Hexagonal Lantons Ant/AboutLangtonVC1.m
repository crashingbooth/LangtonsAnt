...
- (void)viewDidLoad {
   ...
   self.topLabel.lineBreakMode = NSLineBreakByWordWrapping;
    ...
    self.bottomLabel.text = @"Langton’s ant starts out generating an orderly symmetrical pattern for the first 30 or so steps.  Then its behaviour appears highly chaotic for an extended period of time.  After approximately 10,000 steps, an orderly pattern suddenly emerges often referred to as a ‘highway’.  The classic Langton’s ant ‘highway’ generates a pattern with a repeating period of 104 steps.  Each time time the pattern is offset by one cell, and so it projects itself out into infinity.  This progression from orderly behaviour to chaotic to emergent orderly behaviour is one of the fascinating characteristics of Langton’s Ant. This is the 'highway' as it emerges after approc 11,000 steps:";
}
